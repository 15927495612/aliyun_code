...
namespace detail
{
char require_32_bin_integer_at_least[sizeof(int) >= sizeof(int32_t) ? 1 : -1];

int getJulianDayNumber(int year,int month,int day)
{
    (void) require_32_bin_integer_at_least;
    int a = (14 - month) / 12;
    int y = year + 4800 - a;
    int m = month + 12 * a - 3;
...
const int Date::kJulianDayOf1970_01_01 = detail::getJulianDayNumber(1997,1,1);
